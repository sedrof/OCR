...
import os
from .helpers import description_func, supplier_code_func,\
...
class Invoice(models.Model):
    ...
    pdf = models.ForeignKey(File, on_delete=models.CASCADE, related_name='invoice_pdf', null=True, blank=True)
...
def convert_pdf_to_image(sender, instance, created, **kwargs):
    if created:
        ...
        print(instance.pdfs, ' thats intsaaaaaaaaaaaa')
